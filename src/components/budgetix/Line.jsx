...
import { database, storage, firebase, firestore } from "../../firebase.jsx";
...
export default function Line({ line }) {
  ...
  async function deleteLine() {
    ...
    for (const el of flux.path) {
      ...
      batch.update(docRef, {
        totalBalance: firebase.firestore.FieldValue.increment(balanceDiff),
      });
    }
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={closeDialog}>
        ...
        <DialogContent>
          <Typography>Date:{new Date(line.createdAt).toString()}</Typography>
          {line.url && (
